  ...
  return (
    <article className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
      <header className="space-y-5">
        ...
        <h1 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl lg:text-5xl">{post.title}</h1>
          ...
          <div className="space-y-6 break-words text-slate-700">
            <ReactMarkdown
              components={{
                ...
                h2: ({ children }) => <h2 className="text-2xl font-bold text-slate-900">{children}</h2>,
